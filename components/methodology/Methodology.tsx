  ...
  const features = [
    {
      ...
      className: "absolute left-0 top-[23px] max-md:left-0 max-md:top-5 max-sm:order-1"
    },
    {
      ...
      position: "top" as const,
      className: "absolute right-0 top-[23px] max-md:right-0 max-md:top-5 max-sm:order-3"
    },
    {
      ...
      className: "absolute bottom-[23px] left-[11px] max-md:left-0 max-md:bottom-5 max-sm:order-2"
    },
    {
      ...
      alignment: "left" as const,
      position: "bottom" as const,
      className: "absolute right-0 bottom-[60px] max-md:right-0 max-md:bottom-5 max-sm:order-4"
    }
  ];

  return (
    <>
      <section className="box-border flex flex-col gap-16 items-center px-0 py-24 w-full bg-white max-md:gap-12 max-md:px-0 max-md:py-16 max-sm:gap-8 max-sm:px-0 max-sm:py-16">
