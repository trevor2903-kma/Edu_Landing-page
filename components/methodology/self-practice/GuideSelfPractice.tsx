...
export const GuideSelfPractice: React.FC = () => {
  ...
  return (
    <section className="box-border flex gap-24 items-center px-8 py-0 mx-auto my-0 max-w-screen-xl min-h-[476px] max-lg:flex-col max-lg:gap-16 max-md:gap-16 max-md:px-6 max-md:py-0 max-md:max-w-[991px] max-md:min-h-[auto] max-sm:gap-12 max-sm:px-4 max-sm:py-0 max-sm:max-w-screen-sm">
      <aside className="flex relative shrink-0 justify-center items-center w-[529px] max-lg:order-2 max-lg:w-full max-lg:max-w-full max-md:w-full max-md:max-w-[529px] max-sm:w-full max-sm:max-w-full">
        <InputDesign />
      </aside>

      <div className="flex gap-24 items-center w-full max-lg:order-1 max-sm:flex-col max-md:gap-12 max-sm:gap-8">
