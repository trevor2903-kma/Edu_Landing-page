...
export function InputDesign() {
  return (
    <main className=" relative mx-auto my-0 w-full h-[622px] max-w-[1200px] max-md:p-5 max-md:h-auto max-md:max-w-[991px] max-md:min-h-[500px] max-sm:p-4 max-sm:max-w-screen-sm max-sm:h-auto max-sm:min-h-[400px]">
      <BackgroundShapes />
      <TriangleDecorations top="top-60" right="" left="left-2" bottom="" width="w-2.5" height="h-2.5" gap="gap-1" />
      ...
      <img
        ...
        className="object-contain absolute left-12 rounded-lg h-[455px] top-[138px] w-[542px] max-md:h-[364px] max-md:left-[30px] max-md:top-[110px] max-md:w-[434px] max-sm:top-20 max-sm:h-auto max-sm:left-[15px] max-sm:max-w-[350px] max-sm:w-[calc(100%_-_30px)] z-10"
      />
      <SparkleIcon />
    </main>
  );
